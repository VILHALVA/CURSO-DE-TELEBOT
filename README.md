...
* Conforme lemos no https://core.telegram.org/bots/api, que é a documentação da Bot API. Há vários métodos. Um dos mais simples é o método getMe que retorna informações sobre o bot. Então vamos acessar no nosso navegador a URL:
* https://api.telegram.org/bot123456789:ABFCFstx5e1bfbd_WBOYDKITDt80E5hkur5/getMe
