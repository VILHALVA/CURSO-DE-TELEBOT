--from https://github.com/topkecleon/otouto/blob/26c1299374af130bbf8457af904cb4ea450caa51/plugins/commit.lua
...
local action = function(msg)
    if msg.chat.type ~= 'private' and is_admin_cached(msg) then
	    api.sendMessage(msg.chat.id, '`'..commits[math.random(#commits)]..'`', true)
	end
end
