...
from KazukoBot.modules.anime import (airing_query, anime_query, character_query,
        ...
        await client.answer_inline_query(query.id,
                                         results=[
                                             InlineQueryResultPhoto(
                                                 ...
                                                 photo_url="https://telegra.ph/file/e97af23cd24d868c5a7ac.jpg",
                                                 parse_mode="html",
                                                 title="Need Help?",
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                     [[
                                                         ...
                                                         [
                                                         InlineKeyboardButton(
                                                             text="Help", url="https://t.me/KazukoRobot?start=help")
                                                     ]]
                                                 )
                                             ),
                                         ],
